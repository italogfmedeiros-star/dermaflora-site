          ...
          <ul className="mt-6 flex flex-col gap-3">
            {dict.featuredProduct.benefits.map((benefit) => (
              <li key={benefit} className="flex items-start gap-2.5">
                ...
                />
                <span className="text-[15px] leading-relaxed text-df-ink-700">{benefit}</span>
              </li>
            ))}
          </ul>
